...
<figure markdown="span">
  ![CAREamics banner](images/banner_careamics_large.png){ width="400" }
</figure>
...
CAREamics is a library aimed at simplifying the use of state of the art image
...
-   :octicons-desktop-download-24:{ .lg .middle } __Installation__

    ---

    Get started with CAREamics installation.

    [:octicons-arrow-right-24: Installation](./content/installation/)

-   :octicons-milestone-24:{ .lg .middle } __Features__

    ---

    What you can do with CAREamics.

    [:octicons-arrow-right-24: Features](./content/features/)

-   :octicons-repo-24:{ .lg .middle } __Guides__

    ---

    In-depth guides on CAREamics usage and features.

    [:octicons-arrow-right-24: Guides](./content/guides/)

-   :octicons-file-media-24:{ .lg .middle } __Applications__
